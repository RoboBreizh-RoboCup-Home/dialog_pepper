...
def lumiere(session): # thread pour la lumière
	...
	duration = 5.0
	leds_service.fadeRGB("FaceLeds",0, 0, 0,duration)
	leds_service.fadeRGB("EarLeds",0, 0, 0,duration)
	leds_service.fadeRGB("ChestLeds",0, 0, 0,duration)
...
def mouvements(session): # thread pour les mouvements
	...
	angles  = [0.,0.1,0.1,0,-1.3,1.3,-1,1,-1.5,-1.5,0.8,0.8,0.,0.]
